...
prcp_pf,tas_pf,u_pf,v_pf,patm_pf,qatm_pf,lai_pf, slope_x_2d_pf, slope_y_2d_pf, sai_pf,z0m_pf,displa_pf,      &
...
clm_last_rst,clm_daily_rst, pf_nlevsoi, pf_nlevlak)
  ...
  real(r8) :: slope_x_2d_pf((nx+2)*(ny+2)*3)     ! Slope in x-direction from PF
  real(r8) :: slope_y_2d_pf((nx+2)*(ny+2)*3)     ! Slope in y-direction from PF
